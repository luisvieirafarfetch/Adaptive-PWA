(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("http"), require("https"), require("url"), require("zlib"), require("assert"), require("stream"), require("tty"), require("util"));
	else if(typeof define === 'function' && define.amd)
		define("render", ["http", "https", "url", "zlib", "assert", "stream", "tty", "util"], factory);
	else if(typeof exports === 'object')
		exports["render"] = factory(require("http"), require("https"), require("url"), require("zlib"), require("assert"), require("stream"), require("tty"), require("util"));
	else
		root["render"] = factory(root["http"], root["https"], root["url"], root["zlib"], root["assert"], root["stream"], root["tty"], root["util"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_48__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_51__, __WEBPACK_EXTERNAL_MODULE_124__, __WEBPACK_EXTERNAL_MODULE_116__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_121__, __WEBPACK_EXTERNAL_MODULE_122__) {
...
var _Preferences = __webpack_require__(98);

var _Preferences2 = _interopRequireDefault(_Preferences);

var _Comments = __webpack_require__(101);
...
const Loading = () => _react2.default.createElement('div', { className: _index2.default.loading });
...
var p=__webpack_require__(7),r=__webpack_require__(5),t=__webpack_require__(0),w=__webpack_require__(6),x=__webpack_require__(10),y=__webpack_require__(27),aa=__webpack_require__(28),ba=__webpack_require__(18);
...
var _capabilityDisplay = __webpack_require__(133);
...
var _navCommon = __webpack_require__(89);
...
var _idbKeyval = __webpack_require__(24);
...
class Nav extends _react2.default.Component {
    ...
    render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'ul',
                { className: [_navCommon2.default.nav, _nav2.default.nav].join(' ') },
                _react2.default.createElement(
                    'li',
                    { className: _navCommon2.default.link },
                    _react2.default.createElement(
                        'h1',
                        { className: _nav2.default.title },
                        'HN'
                    )
                ),
                _react2.default.createElement(
                    'li',
                    { className: _nav2.default.link },
                    _react2.default.createElement(
            ...
            this.props.children,
            _react2.default.createElement('footer', { className: _nav2.default.footer })
        );
    }
}
...
// removed by extract-text-webpack-plugin
module.exports = {"nav":"bcff0b","title":"_7e1599","footer":"cb5460"};
...
var _DataLoader = __webpack_require__(42);
...
const List = ({ data }) => {
    return _react2.default.createElement(
        'div',
        { className: _list2.default.container },
        _react2.default.createElement(
            'div',
...
const Card = ({ id, index, title, score, by, images }) => _react2.default.createElement(
    ...
    _react2.default.createElement('img', { className: _card2.default.image, src: images.full }),
    _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
...
// removed by extract-text-webpack-plugin
module.exports = {"card":"e9e6a3","image":"_333432"};
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"bb6608","list":"_74c4d7"};
...
// removed by extract-text-webpack-plugin
module.exports = {"loading":"abfdba","spin":"_60c4b3"};
...
var _DataSaver = __webpack_require__(99);

var _DataSaver2 = _interopRequireDefault(_DataSaver);

var _theme = __webpack_require__(100);
...
const Comment = ({ data }) => {
    return _react2.default.createElement(
        ...
        Object.values(data).map((comment, index) => {
            return _react2.default.createElement(
                'article',
                { className: _index2.default.comment, key: index },
                _react2.default.createElement(
                    'div',
                    null,
...
// removed by extract-text-webpack-plugin
module.exports = {"comment":"_66f7b7"};
...
var pkg = __webpack_require__(125);
var createError = __webpack_require__(26);
var enhanceError = __webpack_require__(46);
...
try {
  var supportsColor = __webpack_require__(123);
...
var _capability = __webpack_require__(134);

var _capability2 = _interopRequireDefault(_capability);

var _capability3 = __webpack_require__(135);

var _capability4 = _interopRequireDefault(_capability3);
...
class CapabilityDisplay extends _react.Component {
    ...
    render() {
        return _react2.default.createElement(
            'div',
            { ref: this.container, className: _capability2.default.display },
            _react2.default.createElement(
                'h3',
                { className: _capability2.default.title },
                'Static Properties'
            ),
            _react2.default.createElement(
                'dl',
...
// removed by extract-text-webpack-plugin
module.exports = {"display":"ba8fd8","title":"_730d6a"};
...
var _uaParserJs = __webpack_require__(136);
...
const capabilities = exports.capabilities = {
    ...
    downlink:  false ? navigator.connection.downlink : '',
    saveData:  false ? navigator.connection.saveData : '',
    effectiveType:  false ? navigator.connection.effectiveType : '',
    deviceMemory:  false ? navigator.deviceMemory : '',
    hardwareConcurrency:  false ? navigator.hardwareConcurrency : ''
};
